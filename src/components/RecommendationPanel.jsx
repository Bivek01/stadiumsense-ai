...
export default function RecommendationPanel({ recommendation }) {
  ...
  return (
    <div className={`p-6 rounded-xl shadow-md border ${containerClass} transition-all duration-300 h-full flex flex-col`}>
      ...
      {recommendedGate && (
        <div className="mb-6 bg-white bg-opacity-70 rounded-xl p-5 border border-white border-opacity-50 shadow-sm flex flex-col items-center justify-center text-center">
      ...
      {tips && tips.length > 0 && (
        <div className="bg-white bg-opacity-40 p-4 rounded-lg">
          <h3 className="font-bold text-xs uppercase tracking-wider mb-3 opacity-80 flex items-center gap-2">
